...
def generate_token(azure_client_id, azure_client_secret):
    ...
    response = requests.post("https://login.microsoftonline.com/44ecf5c5-5945-4f24-96ec-a73db8335538/oauth2/v2.0/token", headers=headers, data=data)
...
post_data = {"commandId":"RunPowerShellScript","script":["Write-Host 'Hello World!'"]}
