    ...
    with open(csv_file_name, mode='w', newline='') as file:
        ...
        for response in paginator.paginate():
            for user in response['Users']:
                ...
                inline_policies = [policy_name for policy_name in inline_policies_response['PolicyNames']]
                
                # Get policies attached via groups for the user
                group_attached_policies = []
                for group_name in groups:
                    group_attached_policies.extend(get_group_attached_policies(group_name))
